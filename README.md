...
- `fraud_score = fraudes_encontradas / 5`
...
- fallback exato restrito ao conjunto de maior risco
- fallback compacto com SIMD (`AVX2` quando disponivel, `SSE2` como reserva)
- respostas HTTP pre-montadas para os valores possiveis de `fraud_score`
